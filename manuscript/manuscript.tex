...
{\Large \textbf{NON-OVERLAPPING ENSEMBLE WEIGHTING VIA M\"{O}BIUS DECOMPOSITION: A COOPETITIVE FRAMEWORK FOR DIAGNOSING AND LEVERAGING MODEL INTERACTIONS}}

\vspace{0.9cm}
\rule{\textwidth}{0.4pt}
\vspace{0.9cm}

{A Special Problem Presented to the}\\[8pt]
{Faculty of the Department of Computer Science,}\\[8pt]
{University of the Philippines Cebu}

\vspace{0.8cm}

{In Partial Fulfillment}\\[8pt]
{Of the Requirements for the Degree}\\[8pt]
...
{\textbf{MAXELL G. MILAY}}\\[6pt]
Student

\vspace{1.2cm}

{\textbf{ASST. PROF. DHARYLL PRINCE M. ABELLANA}}\\[6pt]
...
{\textbf{UNIVERSITY OF THE PHILIPPINES}}\\[6pt]
College of Science\\[6pt]
Department of Computer Science

\vspace{1cm}

{\large \textbf{ACCESS PERMISSION}}
...
\hline
Available to the general public & \centering Yes\tabularnewline
\hline
Available only after consultation with author/SP adviser & \centering Yes\tabularnewline
\hline
...
\noindent The special problem entitled: \textbf{``Non-Overlapping Ensemble Weighting via M\"{o}bius Decomposition: A Coopetitive Framework for Diagnosing and Leveraging Model Interactions''} submitted and prepared by MAXELL G. MILAY is approved by:

\vspace{1.4cm}

\begin{center}
\rule{0.5\textwidth}{0.4pt}\\[6pt]
\textbf{DHARYLL PRINCE M. ABELLANA}\\[6pt]
Special Problem Adviser

\vspace{0.5cm}

Date Signed: \underline{\hspace{4cm}}
\end{center}
...
\textbf{ELI EDRIAN L. TAN}\\[6pt]
Officer-in-Charge\\[6pt]
Department of Computer Science

\vspace{0.5cm}

Date Signed: \underline{\hspace{2.5cm}}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.48\textwidth}
\centering
\rule{0.9\textwidth}{0.4pt}\\[6pt]
\textbf{DR. ALVIN G. ROXAS}\\[6pt]
Dean\\[6pt]
College of Science
...
To my special problem adviser, Asst.\ Prof.\ Dharyll Prince M. Abellana, I extend my sincere gratitude for the guidance and direction you provided throughout this work. It is a testament to the quality of your mentorship that this paper found its completion despite the challenges along the way.
